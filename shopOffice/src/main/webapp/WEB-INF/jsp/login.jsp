              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form id="loginform" class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      <label for="yourUsername" class="form-label">관리자 ID</label>
                      <div class="input-group has-validation">
                        <input type="text" id="manageId" name="manageId" class="form-control" required>
                    ...
                    <div class="col-12">
                      ...
                      <input type="password" id="managePwd" name="managePwd" class="form-control" required>
  ...
  <script>
    ...
    function confirmLogin(vo){
    	if(vo.result){
    		...
    		location.href="/dash/main";
    	}else{
    		alert(vo.msg);
    	}
    }
    
    var id = $.cookie('manageId');
    if(id!=''){
    	$('#manageId').val(id);
    }
  </script>
